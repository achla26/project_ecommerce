        ...
        <tr id="variation_row_{{ $counter }}">
            ...
            <td>
                ...
                <input type="number" name="varient_price[]" min="0" step="0.01" class="form-control"
                    value="{{ $productVarients[$key]['price'] ?? $mrp }}">
            </td>
            <td>
                <input type="number" name="varient_mrp[]" min="0" step="0.01" class="form-control"
                    value="{{ $productVarients[$key]['mrp'] ?? $price }}">
            </td>
            <td>
                <input type="text" name="varient_sku[]" value="{{ $productVarients[$key]['sku'] ?? $sku }}"
                    class="form-control">
            </td>
            <td>
                <input type="number" name="varient_qty[]" value="{{ $productVarients[$key]['qty'] ?? $qty }}"
