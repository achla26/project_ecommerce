            ...
            <div class="row">
                                ...
                                <div class="ec-checkout-block ec-check-bill">
                                    ...
                                    <div class="ec-bl-block-content">
                                        ...
                                        <span class="ec-bill-option">
                                            <span>
                                                <input type="checkbox" id="bill1" name="radio-group">
                                                <label for="bill1">I want to use same address for shipping</label>
                                            </span>
                                        </span>
                                            ...
                                            <form action="#" method="post">
                                                <span class="ec-bill-wrap ec-bill-half">
                                                    ...
                                                    <input type="text" name="fname"
                                                        placeholder="Enter your first name" required="" value="{{old('fname')}}">
                                                </span>
                                                <span class="ec-bill-wrap ec-bill-half">
                                                ...
                                                <span class="ec-bill-wrap ec-bill-half">
                                                    ...
                                                    <input type="number" name="mobile_number" placeholder="Enter your Mobile Number"
                                                        required="" value="{{old('mobile_number')}}">
                                                </span>
                                                <span class="ec-bill-wrap ec-bill-half">
                                                    <label>Address 1</label>
                                                    <input type="text" name="billing_address1" placeholder="Address Line 1" value="{{old('address1')}}">
                                                </span>
                                                <span class="ec-bill-wrap ec-bill-half">
                                                    <label>Address 2</label>
                                                    <input type="text" name="billing_address2" placeholder="Address Line 2" value="{{old('address2')}}">
                                                </span>
                                                ...
                                                <span class="ec-bill-wrap ec-bill-half"   id="state_wrapper">
                                                ...
                                                <span class="ec-bill-wrap ec-bill-half" id="province_wrapper" >
                                                    <label>Province</label>
                                                    <input type="text"  name="province" id="province" value="{{$address->province ?? old('province')}}" class="form-control"/>
                                                </span> 
                                                <span class="ec-bill-wrap ec-bill-half"  id="city_wrapper">
                                                    <label>City *</label>
                                                    <span class="ec-bl-select-inner">
                ...
                <div class="ec-checkout-rightside col-lg-4 col-md-12">
                                                ...
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product-left-sidebar.html" class="image">
                                                            ...
                                                            src="{{ asset('storage/' . $product['images'][0]['name']) }}" alt="{{ $product['name']}}" > 
                                                        </a> 
                                                    </div>
                                                </div>
                    ...
                    <div class="ec-sidebar-wrap ec-checkout-del-wrap">
                        ...
                        <div class="ec-sidebar-block">
                            <div class="ec-sb-title">
                                <h3 class="ec-sidebar-title">Delivery Method<div class="ec-sidebar-res"><i
                                            class="ecicon eci-angle-down"></i></div>
                                </h3>
                            </div>
                            <div class="ec-sb-block-content ec-sidebar-dropdown">
